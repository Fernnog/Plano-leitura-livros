...
export function showCadastroForm(planoParaEditar = null) {
    // ... (código da função showCadastroForm permanece inalterado)
...
export function getFormData() {
    // ... (código da função getFormData permanece inalterado)
    const formData = {
...
// ... (as funções renderizarPainelProximasLeituras e renderizarPainelLeiturasAtrasadas permanecem inalteradas)
...
export function registerServiceWorker() {
    // ... (código da função registerServiceWorker permanece inalterado)
...
export function toggleLoading(isLoading) {
    // ... (código da função toggleLoading permanece inalterado)
