...
export function hideAuthForm() {
    ...
    // Esta verificação garante que o botão de login não reapareça se o usuário estiver logado
...
export function renderApp(planos, user) {
    ...
    // Em vez de manipular o estilo de cada botão, controlamos a UI
    // com uma única classe no body. O JS agora só se preocupa com o ESTADO.
