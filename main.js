...
// --- NOVAS FUNÇÕES EXPORTADAS (MOVIDAS DE MAIN.JS) ---

/**
 * Função de wrapper para gerar os dias do plano com base no tipo de definição.
...
/**
 * Constrói um objeto de plano completo a partir dos dados do formulário.
 * @param {object} formData - Os dados do formulário.
 * @param {object|null} planoEditado - O plano original, se estiver em modo de edição.
 * @returns {object} O novo objeto de plano.
 */
