...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initAuth() {
        onAuthStateChanged(auth, (currentUser) => {
            ...
            if (user) {
                ...
                renderizarPlanos(); // Renderizar a lista vazia ou com mensagem
            }
    ...
    window.editarPlano = function(index) {
        ...
        atualizarVisibilidadeBotoesAcao(); // Atualiza botões para o modo cadastro
    ...
    window.editarLinkDrive = function(index) {
        ...
        if (novoLink !== null) {
            ...
            salvarPlanos(planos, (salvoComSucesso) => {
                ...
                renderizarPlanos(); // Re-renderiza para mostrar o link atualizado/removido
            });
        }
    ...
    window.excluirPlano = function(index) {
        ...
        if (confirm(`Tem certeza que deseja excluir o plano "${plano.titulo}"?`)) {
            ...
            salvarPlanos(planos, (salvoComSucesso) => {
                ...
                renderizarPlanos(); // Renderiza a lista atualizada
            });
        }
    };
    ...
    function recalcularPlanoNovaData(index, novaDataFim) {
        ...
        salvarPlanos(planos, (salvoComSucesso) => {
            renderizarPlanos(); // Renderiza mesmo se salvar falhar para mostrar resultado
        });
    }
    ...
    // Botão "Início" (visível na tela de cadastro para voltar)
    ...
    inicioBtn.addEventListener('click', function() {
        ...
        atualizarVisibilidadeBotoesAcao(); // Atualiza botões do header
        renderizarPlanos(); // Re-renderiza caso algo tenha mudado (pouco provável, mas seguro)
    });
    ...
    formPlano.addEventListener('submit', function(event) {
        ...
        if (definicaoPeriodo === 'datas') {
            ...
            // Calcula a data de fim real com base nos dias gerados
             ...
             // Recalcula a data fim real baseada na periodicidade
        ...
        salvarPlanos(planos, (salvoComSucesso) => {
            ...
            // para que o usuário veja o resultado da sua ação (mesmo que localmente)
             renderizarPlanos();
             inicioBtn.click(); // Volta para a tela de listagem
        });
