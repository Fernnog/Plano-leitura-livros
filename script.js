...
+
     ...
     window.recalcularPlanoPeriodoOriginal = function(index) {
         console.log("recalcularPlanoPeriodoOriginal - inicio");
@@ -734,6 +790,7 @@
         renderizarPlanos();
         console.log("recalcularPlanoPeriodoOriginal - fim");
     };
+
 
     // Função recalcular plano nova data
     window.recalcularPlanoNovaData = function(index, novaDataFim) {
@@ -807,7 +864,7 @@
         }


         recalcularPlanoNovaData(index, novaDataFim);
-         console.log("recalcularPlanoPaginasPorDia - fim");
+        console.log("recalcularPlanoPaginasPorDia - fim");
     };
