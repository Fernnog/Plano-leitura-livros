document.addEventListener('DOMContentLoaded', () => {
    ...
    function gerarICS(plano, horarioInicio, horarioFim) {
        ...
        const dataInicioISO = new Date(plano.diasPlano[0].data).toISOString().slice(0, 10).replace(/-/g, "");
        ...
        const dataFimISO = new Date(plano.dataFim).toISOString().slice(0, 10).replace(/-/g, "");
