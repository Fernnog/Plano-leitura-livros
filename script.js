// script.js (Completo com Tag Numérica nos Painéis e ajuste no número do card)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Código já estava correto conforme fornecido, NENHUMA ALTERAÇÃO necessária aqui.
    function renderizarLeiturasAtrasadas() {
        ...
        if (leiturasAtrasadasParaMostrar.length > 0) {
            ...
            // Se não houver itens, a seção permanece oculta OU mostra mensagem "sem atrasos"
            // A lógica de esconder a seção no início já trata isso.
            ...
            // OU: leiturasAtrasadasSection.style.display = 'none'; // Para esconder tudo
        }
    }
    ...
    function renderizarProximasLeituras() {
        ...
        if (proximas3Leituras.length > 0) {
            ...
            proximas3Leituras.forEach(leitura => {
             ...
             // Se não há próximas, mostra a mensagem
    ...
    function renderizarPlanos() {
        ...
        // O estilo do paginador e dos links (números) é tratado pelo CSS
        if (planos.length > 1) {
        ...
        planos.forEach((plano, index) => {
            ...
            planoDiv.innerHTML = `
                <div class="plano-header">
                    {/* ### MODIFICAÇÃO APLICADA ABAIXO ### */}
                    {/* Removemos o ponto final e o espaço após o span */}
    ...
    function togglePaginatorVisibility() {
        ...
        if (listaRect.height > 0 && (listaRect.bottom + 50 > footerRect.top || footerRect.top > windowHeight)) { // Adiciona uma margem de 50px
