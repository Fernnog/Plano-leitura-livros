...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // const authToggleButton = document.getElementById('auth-toggle-button'); // REMOVED
    ...
    // REMOVED authToggleButton EVENT LISTENER
    ...
    loginButton.addEventListener('click', (e) => {
        ...
        signInWithEmailAndPassword(auth, email, password)
            .then((userCredential) => {
                ...
                authFormDiv.style.display = 'none'; // Esconde o formulário de login (pode não ser necessário agora que está sempre visível)
                // authToggleButton.style.display = 'none'; // Esconde o botão "Login" (REMOVED)
    ...
    onAuthStateChanged(auth, (user) => {
        if (user) {
            ...
            authFormDiv.style.display = 'block'; // Garante que o formulário esteja visível inicialmente
            // authToggleButton.style.display = 'block'; // Mostra o botão "Login" (REMOVED) - No caso de deixar o botão "Login" visível fora do form, descomente e ajuste o display do form para none inicialmente se desejar.
        }
    });
